...
public class sfc09AquaRX01 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sfc09_aqua_rx01);
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        setTitle("Aquaculture RX");

        ListView listView = findViewById(R.id.listview);
        String species = setting_global.getpreferences(this, R.string.sfc09_aquarx01);
        ...
        sfc09AquaRX01_Adapter lAdapter = new sfc09AquaRX01_Adapter(this, R.layout.activity_sfc03_species01_adapter, view_adapters);
